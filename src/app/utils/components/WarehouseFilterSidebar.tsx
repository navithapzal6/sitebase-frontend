...
export const emptyWarehouseFilters: WarehouseFilters = {
  warehouse_name: "",
  phone_number: "",
  address: "",
  pincode: "",
...
export default function FilterSidebar({
  ...
  const [draft, setDraft] = useState<WarehouseFilters>(filters);
  ...
  const handleReset = () => {
    setDraft(emptyWarehouseFilters);
    onApply(emptyWarehouseFilters);
  };
      ...
      >
        <div className="flex items-center justify-between border-b border-border px-5 py-4">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-[15px] font-semibold">Filter warehouses</h2>
            {activeCount > 0 && (
        ...
        <div className="flex-1 space-y-4 overflow-y-auto px-5 py-4">
          <Field label="Warehouse name">
            <input
              ...
              onChange={update("warehouse_name")}
            />
          </Field>
